...
class ReallySimpleColorPicker(forms.TextInput):
    ...
    class Media:
        css = {
            "all": (
                STATIC_URL_BASE + "plugins/color_utils/really-simple/colorPicker.css",
            )
        }
        js = (
            "//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js",
            STATIC_URL_BASE + "plugins/color_utils/really-simple/jquery.colorPicker.js",
        )
...
class BootstrapColorPicker(forms.TextInput):
    ...
    class Media:
        css = {
            "all": (
                STATIC_URL_BASE + "plugins/color_utils/bootstrap/css/bootstrap.min.css",
                STATIC_URL_BASE + "plugins/color_utils/bootstrap/css/colorpicker.css",
            )
        }
        js = (
            "//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js",
            STATIC_URL_BASE
            + "plugins/color_utils/bootstrap/js/bootstrap-colorpicker.js",
        )
...
class PhotoshopColorPicker(forms.TextInput):
    ...
    class Media:
        css = {
            "all": (
                STATIC_URL_BASE + "plugins/color_utils/photoshop/css/colorpicker.css",
            )
        }
        js = (
            "//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js",
            STATIC_URL_BASE + "plugins/color_utils/photoshop/js/colorpicker.js",
        )
...
class ColorWheelColorPicker(forms.TextInput):
    ...
    class Media:
        js = (
            "//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js",
            STATIC_URL_BASE + "plugins/color_utils/colorwheel/raphael-min.js",
            STATIC_URL_BASE + "plugins/color_utils/colorwheel/colorwheel.js",
        )
...
<script type="text/javascript">
    ...
    def render(self, name, value, attrs=None):
        ...
        return mark_safe(
            self._render_html(name, value, attrs)
...
class JSColorColorPicker(forms.TextInput):
    ...
    class Media:
        js = (STATIC_URL_BASE + "plugins/color_utils/jscolor/jscolor.js",)
...
class SimpleColorPicker(forms.TextInput):
    ...
    class Media:
        js = (
            "//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js",
            STATIC_URL_BASE
            + "plugins/color_utils/simplecolor/jquery.simple-color.min.js",
        )
...
class SpectrumColorPicker(forms.TextInput):
    ...
    class Media:
        css = {"all": (STATIC_URL_BASE + "plugins/color_utils/spectrum/spectrum.css",)}
        js = (
            "//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js",
            STATIC_URL_BASE + "plugins/color_utils/spectrum/spectrum.js",
        )
...
class FarbtasticColorPicker(forms.TextInput):
    ...
    class Media:
        css = {
            "all": (STATIC_URL_BASE + "plugins/color_utils/farbtastic/farbtastic.css",)
        }
        js = (
            "//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js",
            STATIC_URL_BASE + "plugins/color_utils/farbtastic/farbtastic.js",
        )
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#%s').farbtastic('#%s');
            ...
            self._get_colorpicker_id(input_id),
            input_id,
        )
        return js
    ...
    def render(self, name, value, attrs=None):
        if not "id" in attrs:
            attrs["id"] = "id_%s" % name
        return mark_safe(
            self._render_html(name, value, attrs) + self._render_js(attrs["id"], value)
        )
...
#    """
#    class Media:
#        js = [STATIC_URL_BASE + 'plugins/color_utils/farbtastic/farbtastic.js',]
#
#    def _render_js(self, input_id, value):
#        js = u"""
# <script type="text/javascript">
...
class jPickerColorPicker(forms.TextInput):
    ...
    class Media:
        css = {
            "all": (
                STATIC_URL_BASE
                + "plugins/color_utils/jpicker/css/jpicker-1.1.6.min.css",
            )
        }
        js = (
            "//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js",
            STATIC_URL_BASE + "plugins/color_utils/jpicker/jpicker-1.1.6.min.js",
        )
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#%s').jPicker({
            images: {
                clientPath: '%splugins/color_utils/jpicker/images/'
            }
        });
    });
</script>""" % (
...
class FlexiColorPicker(forms.TextInput):
    ...
    class Media:
        css = {"all": (STATIC_URL_BASE + "plugins/color_utils/flexi/themes.css",)}
        js = (
            "//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js",
            STATIC_URL_BASE + "plugins/color_utils/flexi/colorpicker.js",
        )
...
class MooRainbowColorPicker(forms.TextInput):
    ...
    class Media:
        css = {
            "all": (STATIC_URL_BASE + "plugins/color_utils/moorainbow/mooRainbow.css",)
        }
        js = (
            STATIC_URL_BASE + "plugins/color_utils/moorainbow/mootools.v1.11.js",
            STATIC_URL_BASE + "plugins/color_utils/moorainbow/mooRainbow.js",
        )

    #        # Note: doesn't seem to work with mootools > 1.11
    #        js = (STATIC_URL_BASE + 'plugins/color_utils/moorainbow/mootools-core-1.4.5-full-compat-yc.js',
    #              STATIC_URL_BASE + 'plugins/color_utils/moorainbow/mootools-more-1.4.0.1.js',  # required for Drag
    #              STATIC_URL_BASE + 'plugins/color_utils/moorainbow/mooRainbow.1.2b2.js',)
...
class MenuCoolColorPicker(forms.TextInput):
    ...
    class Media:
        css = {
            "all": (STATIC_URL_BASE + "plugins/color_utils/menucool/mcColorPicker.css",)
        }
        js = (STATIC_URL_BASE + "plugins/color_utils/menucool/mcColorPicker.js",)
    ...
    def render(self, name, value, attrs=None):
        ...
        return render_to_string("plugins/color_utils/menucool.html", locals())
